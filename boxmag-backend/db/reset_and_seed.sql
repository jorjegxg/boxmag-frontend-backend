...
INSERT INTO box_type_products
  (box_type_id, item_no, product_name, internal_l_mm, internal_w_mm, internal_h_mm, internal_h2_mm, quality_cardboard, pallet_l_cm, pallet_w_cm, pallet_h_cm, weight_piece_gr, weight_pallet_kg, amount_qty_in_pcs, pallet_pcs)
VALUES
  (1, 'BF10', 'BF10 BOXFIX', 160, 130, 80, NULL, '1.21B-31', 120, 85, 160, 63, 219, 20, 3200),
  (1, 'BF11', 'BF11 BOXFIX', 200, 150, 150, NULL, '1.21B-31', 125, 80, 160, 98, 177, 20, 1600),
  (1, 'BF15', 'BF15 BOXFIX', 210, 210, 100, NULL, '1.21B-31', 124, 80, 160, 122, 166, 20, 1200),
  (1, 'BF20', 'BF20 BOXFIX', 215, 155, 110, NULL, '1.21B-31', 120, 84, 180, 95, 208, 20, 1980),
  (1, 'BF20E', 'BF20E BOXFIX', 216, 156, 112, NULL, '1.20E-21', 120, 80, 180, 84, 292, 20, 3240),
  (1, 'BF22', 'BF22 BOXFIX', 215, 180, 130, NULL, '1.21B-31', 140, 80, 160, 119, 206, 20, 1560),
  (1, 'BF30', 'BF30 BOXFIX', 230, 162, 80, NULL, '1.21B-31', 128, 80, 160, 94, 208, 20, 2000),
  (1, 'BF30E', 'BF30E BOXFIX', 231, 151, 82, NULL, '1.20E-21', 120, 80, 180, 83, 319, 20, 3600),
  (1, 'BF33', 'BF33 BOXFIX', 260, 222, 130, NULL, '1.21B-31', 120, 85, 180, 164, 200, 20, 1100),
  (1, 'BF35', 'BF35 BOXFIX', 306, 216, 140, 222, '1.21B-31', 120, 90, 160, 205, 200, 20, 880),
  (1, 'BF37', 'BF37 BOXFIX', 290, 190, 82, NULL, '1.21B-31', 120, 80, 160, 169, 155, 20, 800),
  (1, 'BF40', 'BF40 BOXFIX', 312, 232, 82, 160, '1.21B-31', 280, 88, 132, 192, 174, 20, 800),
  (1, 'BF41', 'BF41 BOXFIX', 312, 230, 112, NULL, '1.21B-31', 120, 80, 160, 182, 165, 20, 800),
  (1, 'BF42', 'BF42 BOXFIX', 312, 230, 162, NULL, '1.21B-31', 120, 82, 160, 203, 182, 20, 800),
  (1, 'BF50', 'BF50 BOXFIX', 350, 255, 135, NULL, '1.21B-31', 123, 80, 160, 225, 200, 20, 800),
  (1, 'BF55', 'BF55 BOXFIX', 392, 292, 180, NULL, '1.21B-31', 120, 80, 160, 305, 143, 20, 400);
