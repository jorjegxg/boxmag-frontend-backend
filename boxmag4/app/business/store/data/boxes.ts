...
const boxes: Box[] = [
  ...
  },
  {
    ...
    imageUrl: "/b2b/boxes/flaps_box.png",
  },
  {
    id: 3,
...
const carboarbonTypeOptions: CarboardTypeOption[] = [
  { id: 1, key: "b_wave", name: "B Wave", imageUrl: "/b2b/carboard_types/b_wave.svg" },
  { id: 2, key: "c_wave", name: "C Wave", imageUrl: "/b2b/carboard_types/c_wave.svg" },
  { id: 3, key: "e_wave", name: "E Wave", imageUrl: "/b2b/carboard_types/e_wave.svg" },
];

const boxColorOptions: BoxColorOption[] = [
    { id: 1, key: "brown_on_both_side", name: "Brown On Both Side", imageUrl: "/b2b/carboard_colors/brown_on_both_sides.svg" },
    { id: 2, key: "white_on_both_side", name: "White On Both Side", imageUrl: "/b2b/carboard_colors/white_on_both_sides.svg" },
    { id: 3, key: "white_outside_brown_inside", name: "White Outside Brown Inside", imageUrl: "/b2b/carboard_colors/whote_outside_brown_inside.svg" },
];
