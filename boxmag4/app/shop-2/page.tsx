    ...
    <div>
      ...
      <section className="w-full bg-white px-6 lg:px-20 pt-6">
        <div className="max-w-7xl mx-auto text-xs lg:text-sm text-gray-500 uppercase tracking-wide">
          ...
          <span className="mx-2">→</span>
          <span className="text-gray-700 font-semibold">{t("home.corrugated.title")}</span>
        </div>
      </section>
          ...
          <div className="rounded-[28px] border border-black/20 bg-[#f2f2f2] px-6 py-10 lg:px-12 lg:py-12">
            ...
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-8 lg:gap-12 items-end">
              {[
                ...
                >
                  <div className="w-full max-w-[250px] h-[180px] lg:h-[210px] flex items-center justify-center overflow-hidden">
                    <Image
                      src={src}
                      alt={alt}
                      width={350}
            ...
            <div className="mt-10 text-center max-w-5xl mx-auto text-black">
              <p className="leading-relaxed text-lg">
                Crafted from high-quality E-flute corrugated cardboard our "M-EV" range envelopes guarantee a
                high level of bend protection for your items throughout the shipping process.
              </p>
              <p className="mt-5 leading-relaxed text-lg">
                Engineered with box-form capacity these envelopes offer an unmatched durability compared to
                conventional postal options.
              </p>
              <p className="mt-5 leading-relaxed text-lg">
                Designed for efficiency our envelopes simplify the packaging process and save you valuable time.
              </p>
              <p className="mt-5 leading-relaxed text-lg">
                Is available in various sizes and can be used universally both as an envelope and a box.
                They are made from 100% biodegradable and fully recyclable materials. Corrugated cardboard is a
      ...
      <section className="w-full px-4 py-10 sm:px-6 lg:px-20 bg-[#f2f2f2]">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl lg:text-5xl font-extrabold text-[#16c8c2] uppercase leading-tight mb-8">
          ...
          <div className="-mx-4 sm:mx-0 min-w-0">
            <Shop2ProductsTable />
            <p className="mt-5 text-sm text-gray-500">Showing 1-5 of 5 item(s)</p>
          </div>
        </div>{" "}
      </section>
