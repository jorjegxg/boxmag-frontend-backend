 ...
 *
 * Run from boxmag4 (sharp must resolve from boxmag4/node_modules):
...
const boxmag4Root = path.resolve(__dirname, "..");
const repoRoot = path.resolve(boxmag4Root, "..");
